...
import 'confirmed_description_widget.dart';

class WaitConfirmedWidget extends GetView<ConfirmedController> {
  final Determined? model;
  final int km;
  const WaitConfirmedWidget({Key? key, this.model, required this.km})
      : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
              ...
              child: ButtonWidget(
                onTap: () {
                  Get.to(() => ConfirmedDescriptionWidget(
